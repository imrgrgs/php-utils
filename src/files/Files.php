...
class Files
{
    ...
    public function infos($path = null, $withroot = true, $content = true, $byline = false, $length = 1024)
    {
        ...
        if (is_dir($path)) {
            if ($handle = opendir($path)) {
                ...
                $infos['files'] = array_map(array(
                    $this,
                    'format_path'
                ), $infos['files']);
                $infos['directories'] = array_map(array(
                    $this,
                    'format_path'
                ), $infos['directories']);
    ...
    public function tree($path = null, $expand2files = true)
    {
        ...
        if ($expand2files) {
            ...
            $expanded_directories = array_map(array(
                $this,
                'format_path'
