...
class MyCSV_MySQL extends MyCSV
{
    ...
    function fromMySQL($source = "")
    {
        ...
        if (! is_resource($source)) {
            ...
            if (! $source)
                list ($source) = explode(".", basename($this->filename));
    ...
    function toSQL($tablename = "")
    {
        ...
        $sqlArray = array(
            "DROP TABLE IF EXISTS " . $this->_backquote($tablename) . ";"
        );
    ...
    /**
     * Quotes database and table names with back quotes.
